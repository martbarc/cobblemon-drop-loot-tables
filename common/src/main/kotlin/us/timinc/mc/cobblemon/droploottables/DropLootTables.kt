...
import us.timinc.mc.cobblemon.droploottables.condition.WasInBattleCondition
...
object DropLootTables : AbstractMod<DropLootTables.DropLootTablesConfig>(MOD_ID, DropLootTablesConfig::class.java) {
    ...
    object DataKeys {
        ...
        object DropConditionKeys {
            ...
            val EGG_GROUPS = modResource("egg_groups")
            ...
            val WAS_IN_BATTLE = modResource("was_in_battle")
        }
    ...
    object LootParams {
        ...
        val WAS_IN_BATTLE: LootContextParam<Boolean> = register(DataKeys.LootParamKeys.WAS_IN_BATTLE)
    ...
    object LootItemConditionTypes {
        ...
        val MOVE_TYPES_CONDITION =
            register(DataKeys.DropConditionKeys.MOVE_TYPES, MovesCondition.CODEC)
        ...
        val WAS_IN_BATTLE_CONDITION =
            register(DataKeys.DropConditionKeys.WAS_IN_BATTLE, WasInBattleCondition.CODEC)
